...
namespace TeamPortal.Web.Models
{
    public class TeamPortalWebContext : DbContext
    {
        ...
        public TeamPortalWebContext()
            : base("TeamPortalWebContext")
        {
        }

        public DbSet<TeamPortal.Web.Models.Player> Players { get; set; }

        public DbSet<TeamPortal.Web.Models.Team> Teams { get; set; }

        public DbSet<TeamPortal.Web.Models.State> States { get; set; }
    }
}